        ...
        <el-form-item>
          <el-row type="flex" style="flex-wrap: wrap">
            <el-col :md="24" v-for="(item, i) in model.major" :key="i">
              <el-form-item label="专业(系)名称：">
                <el-input v-model="item.major_name" placeholder=""></el-input>

                <div>
                  <el-button type="primary" @click=addClass(item.class) size="mini">
                ...
                <el-button size="small" type="danger" @click="model.major.splice(i, 1)">删除专业</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form-item>
